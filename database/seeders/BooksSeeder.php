...
class BooksSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $author3 =Author::create(['name'=>'Takdir R A Syahbana']);

        //membuat sample book
        $book1 = Book::create(['title' => "Seminggu Belajar Laravel",
        'amount' => 353, 'author_id' => $author1 -> id,
    ]);
        $book1 = Book::create(['title' => "Rintik Sedu",
        'amount' => 157, 'author_id' => $author2 -> id,
    ]);
        $book1 = Book::create(['title' => "Sobat Sakit",
        'amount' => 251, 'author_id' => $author3 -> id,
    ]);
        $book1 = Book::create(['title' => "Bincang Akhlak",
